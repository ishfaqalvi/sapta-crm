...
export default function RoleCreate({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create New System Role" />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
                            Define the role title and assign granular access permissions across Admin Panel & Client Portal.
                        </p>
                    </div>
                    ...
                    <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-5">
                        <div className="flex items-center gap-3 pb-4 border-b border-slate-100 dark:border-slate-800">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-400">
                                    Specify a unique name for this role (e.g. Sales Executive, Billing Manager, Support Lead).
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="max-w-2xl space-y-2">
                            ...
                            <Input
                                id="role_name"
                                type="text"
                                placeholder="e.g. Billing Manager, Operations Lead, Auditor..."
                        ...
                        >
                            {form.processing ? (
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>Creating System Role...</span>
                                </div>
                            ) : (
