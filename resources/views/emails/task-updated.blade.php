...
<head>
    ...
    <style>
        ...
        /* Header */
        .header-bar { background: linear-gradient(135deg, #0f172a 0%, #003796 50%, #2563eb 100%); padding: 32px 30px; text-align: left; color: #ffffff; }
        ...
        /* Attachment Note */
        .attachment-box { margin-top: 14px; padding: 10px 14px; background-color: #eff6ff; border-radius: 8px; font-size: 12px; color: #1e40af; border: 1px solid #dbeafe; }
                ...
                <td align="center">
                    <div class="main-card">
                        ...
                        <div class="header-bar">
                            <span class="brand-badge">{{ config('app.name', 'Sapta CRM') }} &bull; Task Management</span>
                            <h1 class="header-title">&#128221; Task Details Updated</h1>
                        </div>
                        ...
                        <div class="content-body">
                            ...
                            <div class="intro-text">
                                A task assigned to you has been updated by <strong>{{ $details['updated_by_name'] }}</strong>. Please review the updated information and timeline below.
                            </div>

                            <!-- Task Details Box -->
                            <div class="task-box">
                                <div class="task-title">
                                    <span style="font-family: monospace; font-size: 13px; color: #64748b; font-weight: 700; margin-right: 6px;">
                                        [{{ $details['task_code'] }}]
                                    </span>
                                    {{ $details['task_title'] }}
                                </div>
                                ...
                                <table class="info-table">
                                    ...
                                    <tr>
                                        <td class="info-label">Client / Account:</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="info-val">
                                            <span style="display: inline-block; padding: 2px 8px; border-radius: 6px; background-color: #f1f5f9; color: #334155; font-size: 11px; font-weight: 800; text-transform: uppercase;">
                                                {{ $details['status'] }}
                                            </span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="info-val">{{ $details['updated_by_name'] }}</td>
                                    </tr>
                                </table>
                                ...
                                <div class="desc-box">
                                    <div class="desc-title">Description & Scope</div>
                            ...
                            <div class="btn-wrapper">
                                <a href="{{ $details['action_url'] }}" target="_blank" class="btn">
                                    View Task Details & Discussion &rarr;
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="footer-bar">
                            ...
                            <p style="margin: 0;">Please log into your portal to view latest task progress and collaborate with your team.</p>
                        </div>
