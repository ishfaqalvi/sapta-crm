...
interface ClientServicesCreateProps {
    clients: SimpleClient[];
    categories: ServiceCategoryOption[];
}

export default function ClientServiceCreate({ clients, categories }: ClientServicesCreateProps) {
    const form = useForm({
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                            Set up service retainers, monthly fees, contract duration in months, billing schedule, and assign to client.
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    placeholder="e.g. Dedicated Web Maintenance / SMM Retainer"
                    ...
                    <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-5">
                        <div className="flex items-center gap-3 pb-4 border-b border-slate-100 dark:border-slate-800">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-400">
                                    Monthly dues, contract duration in months, billing currency, start date, and billing day.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-5">
                        <div className="flex items-center gap-3 pb-4 border-b border-slate-100 dark:border-slate-800">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-400">
                                    Key deliverables, scope notes, or special instructions for this service.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-1.5">
                            <textarea
                                ...
                                placeholder="Add any custom instructions, scope details, server parameters, or deliverables..."
                                className="w-full p-4 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs font-medium text-slate-900 dark:text-white placeholder:text-slate-400 focus:bg-white focus:border-blue-600 focus:outline-none transition-all"
                            />
