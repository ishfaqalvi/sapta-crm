...
export default function EditClientInvoice({
    ...
    const { data, setData, put, processing, errors } = useForm({
        website_project_id: invoice.website_project_id || '',
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        put(`/client-portal/invoices/update/${invoice.id}`);
    };
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200/80 dark:border-slate-800">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400 text-xs mt-0.5">
                                Modify billing invoice details and line items for {client.name}.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            ...
                            <span>{processing ? 'Updating...' : 'Update Invoice'}</span>
                        </button>
                    </div>
                </div>
