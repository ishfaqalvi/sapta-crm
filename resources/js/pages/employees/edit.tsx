...
export default function EmployeeEdit({ employee, departments, designations, users, roles = [] }: EmployeeEditProps) {
    ...
    const initialRoles = employee.user?.roles ? employee.user.roles.map((r) => r.name) : [];
    ...
    const form = useForm({
        ...
        create_user_account: !employee.user_id,
        password: '',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 sm:p-6 bg-slate-50/50 dark:bg-slate-950">
                {/* Page Header matching Client Edit Standard */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
                            Modify staff details, department allocation, salary PKR, and system login account.
                        </p>
                    </div>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-6">
                    ...
                    <div className="p-6 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-5">
                        ...
                        {/* Photo Upload Box */}
                        <div className={`flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-950 border transition-all ${form.errors.avatar
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    required
                                    className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-sm font-semibold text-slate-900 dark:text-white placeholder:text-slate-400 transition-all ${form.errors.name
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    required
                                    className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-sm font-semibold text-slate-900 dark:text-white placeholder:text-slate-400 transition-all ${form.errors.email
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                                        : 'border-slate-200 dark:border-slate-800 focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10'
                                        }`}
                                />
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-sm font-medium text-slate-900 dark:text-white placeholder:text-slate-400 transition-all ${form.errors.phone
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                                        : 'border-slate-200 dark:border-slate-800 focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10'
                                        }`}
                                />
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-sm font-medium text-slate-900 dark:text-white placeholder:text-slate-400 transition-all ${form.errors.emergency_contact
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                                        : 'border-slate-200 dark:border-slate-800 focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10'
                                        }`}
                                />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-xs font-semibold text-slate-900 dark:text-white transition-all ${form.errors.joining_date
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                                        : 'border-slate-200 dark:border-slate-800 focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10'
                                        }`}
                                />
                            ...
                            <div className="space-y-1.5">
                                ...
                                <select
                                    ...
                                    className={`w-full h-11 px-3 rounded-xl bg-slate-50 dark:bg-slate-950 border text-xs font-semibold text-slate-900 dark:text-white focus:outline-none transition-all ${form.errors.employment_type
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                                        : 'border-slate-200 dark:border-slate-800 focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10'
                                        }`}
                                >
                            ...
                            <div className="space-y-1.5">
                                ...
                                <select
                                    ...
                                    className={`w-full h-11 px-3 rounded-xl bg-slate-50 dark:bg-slate-950 border text-xs font-semibold text-slate-900 dark:text-white focus:outline-none transition-all ${form.errors.status
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                                        : 'border-slate-200 dark:border-slate-800 focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10'
                                        }`}
                                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-sm font-extrabold text-slate-900 dark:text-white transition-all ${form.errors.base_salary_pkr
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-sm font-semibold text-slate-900 dark:text-white transition-all ${form.errors.allowed_paid_leaves
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                                        : 'border-slate-200 dark:border-slate-800 focus:bg-white focus:border-emerald-600 focus:ring-4 focus:ring-emerald-600/10'
                                        }`}
                                />
                    ...
                    {/* Section 4: System User Account Configuration */}
                    <div className="p-6 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-5">
                        <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-400">
                                        {employee.user
                                            ? `Linked to user account: ${employee.user.email} (Type: Employee)`
                        ...
                        {(employee.user || form.data.create_user_account) && (
                            <div className="space-y-4 animate-in fade-in zoom-in-95 duration-200">
                                <div className="space-y-1.5 max-w-md">
                                    <Label htmlFor="emp_user_password" className="text-xs font-bold text-slate-700 dark:text-slate-300">
                                        {employee.user ? 'Update Password (Leave blank to keep current)' : 'Login Password *'}
                                    </Label>
                                    <Input
                                        ...
                                        placeholder={employee.user ? '••••••••' : 'Minimum 8 characters...'}
                                        required={!employee.user && form.data.create_user_account}
                                        className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-sm font-semibold text-slate-900 dark:text-white transition-all ${form.errors.password
                                            ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                                            : 'border-slate-200 dark:border-slate-800 focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10'
                                            }`}
                                    />
                                ...
                                {roles.length > 0 && (
                                    <div className="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                                        ...
                                        <div className={`grid grid-cols-2 sm:grid-cols-3 gap-2 p-2.5 rounded-xl bg-slate-50 dark:bg-slate-950 border transition-all ${form.errors.roles
                                            ? 'border-rose-500 ring-2 ring-rose-500/20'
                                            : 'border-slate-200/80 dark:border-slate-800'
                                            }`}>
                                            {roles.map((role) => {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-sm font-medium text-slate-900 dark:text-white placeholder:text-slate-400 transition-all ${form.errors.bank_name
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-sm font-medium text-slate-900 dark:text-white placeholder:text-slate-400 transition-all ${form.errors.account_number
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                                        : 'border-slate-200 dark:border-slate-800 focus:bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-600/10'
                                        }`}
                                />
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Input
                                    ...
                                    className={`h-11 rounded-xl bg-slate-50 dark:bg-slate-950 text-sm font-medium text-slate-900 dark:text-white placeholder:text-slate-400 transition-all ${form.errors.iban
                                        ? 'border-rose-500 ring-2 ring-rose-500/20 focus:border-rose-500 focus:ring-rose-500/20'
                                        : 'border-slate-200 dark:border-slate-800 focus:bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-600/10'
                                        }`}
                                />
