...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Create Spatie Roles with exact title case names
        ...
        // Give standard permissions to Admin role
        $adminPermissions = Permission::whereNotIn('name', ['delete-roles'])->get();
        $adminRole->syncPermissions($adminPermissions);

        // Create Primary Super Admin User (ID 1)
        ...
        $superUser->syncRoles([$superAdminRole->name]);

        // Seed Default Departments & Sub-Departments
        ...
        // Call ClientSeeder to populate sample clients, retainers & payment logs
