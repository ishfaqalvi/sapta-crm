...
export default function QuotationEdit({ quotation, currencies }: QuotationEditProps) {
    const currencyCode = quotation.currency_code || 'AED';
    ...
    const { data, setData, post, processing, errors } = useForm<{
        ...
        exchange_rate_to_pkr: Number(quotation.exchange_rate_to_pkr) || 1,
        subject: quotation.subject || '',
        customer_prefix: quotation.customer_prefix || '',
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Edit Quotation', href: `/quotations/${quotation.id}/edit` },
    ];
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400 text-xs mt-0.5">
                                Update quote specifications, pricing line items, and terms ({currencyCode}).
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center gap-2.5 pb-3 border-b border-slate-100 dark:border-slate-800">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-slate-400 font-medium">
                                    Quotation number, issue date, and validity (Currency: {currencyCode})
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100 dark:border-slate-800">
                            <div className="flex items-center gap-2.5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] text-slate-400 font-medium">
                                        Company provider details for this quotation.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-2 pb-4 border-b border-slate-100 dark:border-slate-800">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                        {quotation.company_logo && !data.remove_company_logo && (
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2.5 pb-3 border-b border-slate-100 dark:border-slate-800">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-slate-400 font-medium">
                                    Signatory designation text and optional signature image upload
                                </p>
                            </div>
                        </div>
