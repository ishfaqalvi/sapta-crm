...
import { type WebsiteProjectItem } from './index';
...
export default function WebsiteProjectEdit({ project, clients }: WebsiteProjectEditProps) {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        form.put(`/website-projects/${project.id}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Website Project - ${project.project_name}`} />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                            Update contract specifications, progress percentage, total budget, and milestone deadlines.
                        </p>
                    </div>
