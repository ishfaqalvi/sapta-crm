        ...
        <ClientPortalLayout client={client} breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-2 md:p-6 bg-slate-50/50 dark:bg-slate-950">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs flex items-center justify-between">
                        <div>
                            <p className="text-[11px] font-bold uppercase tracking-wider text-amber-600 dark:text-amber-400">Total Unpaid Amount</p>
                            ...
                            {transactions.length > 0 && (
                                <tfoot className="border-t-2 border-slate-200 dark:border-slate-800">
                                    ...
                                    <tr className="bg-emerald-50/50 dark:bg-emerald-950/20 text-xs">
                                        <td colSpan={4} className="py-3 px-4 text-right font-bold text-emerald-800 dark:text-emerald-300">
                                    ...
                                    <tr className="bg-amber-50/50 dark:bg-amber-950/20 border-t border-slate-200/60 dark:border-slate-800/80 text-xs">
                                        <td colSpan={4} className="py-3 px-4 text-right font-bold text-amber-800 dark:text-amber-300">
                                            <span className="inline-flex items-center gap-1.5 uppercase tracking-wider text-[11px]">
                                    ...
                                    <tr className="bg-slate-100/90 dark:bg-slate-950/90 border-t-2 border-slate-300 dark:border-slate-700 font-bold text-xs">
                                        <td colSpan={4} className="py-3.5 px-4 text-right uppercase tracking-wider text-slate-700 dark:text-slate-300">
