...
export default function QuotationShow({ quotation }: QuotationShowProps) {
    ...
    const canEdit = hasPermission(authUser, 'edit-quotations');
    const canDelete = hasPermission(authUser, 'delete-quotations');
    const canPrint = hasPermission(authUser, 'print-quotations');
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: `${documentTypeLabel} ${quotation.quotation_number}`, href: `/quotations/${quotation.id}` },
    ];

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`${documentTypeLabel} ${quotation.quotation_number}`} />
            ...
            <div className="p-3 sm:p-6 lg:p-8 space-y-6 max-w-4xl mx-auto print:p-0 print:max-w-full">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {canPrint && (
                            <>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 text-blue-600 dark:text-blue-400 text-xs font-bold transition-all"
                                >
                        ...
                        {canEdit && (
                            <Link
                                ...
                                className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#003796] hover:bg-[#002b75] text-white text-xs font-bold shadow-xs transition-all cursor-pointer"
                            >
                        ...
                        {canDelete && (
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-rose-50 dark:bg-rose-950/40 hover:bg-rose-100 text-rose-600 dark:text-rose-400 text-xs font-bold transition-all cursor-pointer"
                            >
                ...
                {/* Printable Document Paper Card (Exact Layout from Client Portal) */}
                <div
                        ...
                        <div className="w-full sm:w-1/4 flex justify-start items-center">
                            {quotation.company_logo ? (
                                <img
                                    ...
                                    alt={quotation.company_name || 'Company Logo'}
                    ...
                    <div className="pt-8 flex justify-end">
                        <div className="w-64 sm:w-72 text-center space-y-2">
                            <div className="font-black text-xs sm:text-sm text-slate-900 uppercase">
                                {quotation.authorized_by_text || (quotation.company_name ? `For, ${quotation.company_name}` : '')}
                            </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl max-w-md w-full p-6 space-y-4 shadow-xl border border-slate-200 dark:border-slate-800">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500">
                                    Are you sure you want to delete {quotation.quotation_number}? This action cannot be undone.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-end gap-3 pt-2">
                            ...
                            <button
                                ...
                                disabled={isDeleting}
                                className="px-4 py-2 rounded-xl text-xs font-bold bg-rose-600 hover:bg-rose-700 text-white flex items-center gap-2"
                            >
