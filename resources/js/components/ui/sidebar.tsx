...
const SidebarContent = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => {
    return (
        <div
            ...
            className={cn(
                'flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden custom-scrollbar group-data-[collapsible=icon]:overflow-y-auto group-data-[collapsible=icon]:overflow-x-hidden group-data-[collapsible=icon]:[scrollbar-width:none] group-data-[collapsible=icon]:[&::-webkit-scrollbar]:hidden',
                className,
            )}
            {...props}
        />
