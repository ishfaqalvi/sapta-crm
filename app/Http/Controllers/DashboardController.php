...
class DashboardController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        $canViewDashboard = $user->hasRole('Super Admin')
        ...
        // 1. Financial KPIs (Comprehensive Cross-Module Aggregations)
        ...
        // 2. Revenue & Cash Flow Trend (Last 6 Months)
        $monthsTrend = [];
        for ($i = 5; $i >= 0; $i--) {
        ...
        // 3. Revenue Stream Breakdown Donut / Pie
        $revenueStreams = [
        ...
        // 10. Recent Incomes & Expenses Feed
