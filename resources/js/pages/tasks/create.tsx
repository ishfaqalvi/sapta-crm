...
export default function TasksCreate({ categories = [], employees = [], next_code }: TasksCreateProps) {
    const [selectedFile, setSelectedFile] = useState<File | null>(null);

    const form = useForm({
        task_title: '',
        task_category_id: '' as number | string,
        assigned_employee_id: '' as number | string,
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Add New General Task" />
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 sm:p-6 bg-slate-50/50 dark:bg-slate-950">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
                            Assign general task to team member, set category, timeline, priority, and attachments.
                        </p>
                    </div>
                ...
                <form noValidate onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center gap-3 pb-4 border-b border-slate-100 dark:border-slate-800">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-400">
                                    Task title, category classification, employee assignment, priority level, and initial status.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <select
                                        ...
                                        className={`w-full h-11 px-3 rounded-xl bg-slate-50 dark:bg-slate-950 text-xs font-semibold text-slate-900 dark:text-white transition-all focus:outline-none ${
                    ...
                    {/* Section 2: Schedule & Document Attachment */}
                    <div className="p-6 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-5">
                        <div className="flex items-center gap-3 pb-4 border-b border-slate-100 dark:border-slate-800">
                    ...
                    <div className="p-6 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-xs space-y-5">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                className={`w-full rounded-xl bg-slate-50 dark:bg-slate-950 p-3 text-sm font-medium text-slate-900 dark:text-white placeholder:text-slate-400 transition-all focus:outline-none ${
                    ...
                    <div className="flex items-center justify-end gap-4 pt-4 pb-12 border-t border-slate-200/80 dark:border-slate-800">
                        ...
                        <Button
                            ...
                            className="h-10 px-5 text-sm font-bold rounded-xl bg-gradient-to-r from-[#003796] via-[#0052D4] to-[#1d4ed8] hover:from-[#002a75] hover:to-[#0040b8] text-white shadow-lg shadow-blue-600/20 active:scale-[0.99] transition-all flex items-center justify-center gap-2 cursor-pointer"
                        >
                            {form.processing ? (
