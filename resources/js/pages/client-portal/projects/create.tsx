...
export default function ClientPortalProjectsCreate({
    ...
    return (
        <ClientPortalLayout client={client} breadcrumbs={breadcrumbs} activeTab="projects">
            <Head title={`Create Website Project | ${client.name}`} />
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400 text-xs mt-0.5">
                                Set up milestone parameters, project budget, and deadlines for {client.name}.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Corporate Redesign & E-Commerce Web Portal"
                                    className={`w-full h-10 px-4 rounded-xl bg-slate-50 dark:bg-slate-950 border text-xs font-medium text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none transition-all ${errors.project_name
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="5000"
                                        className={`w-full h-10 pl-9 pr-4 rounded-xl bg-slate-50 dark:bg-slate-950 border text-xs font-medium text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none transition-all ${errors.total_budget
                                            ? 'border-rose-500 focus:ring-2 focus:ring-rose-500/20'
                                            : 'border-slate-200 dark:border-slate-800 focus:border-blue-600 focus:ring-2 focus:ring-blue-600/10'
                                            }`}
                                    />
