...
export default function EmployeeCreate({ departments, designations, users }: EmployeeCreateProps) {
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                            Fill in staff profile details, department assignments, and PKR base compensation.
                        </p>
                    </div>
                            ...
                            <div className="space-y-1.5">
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        accept="image/*"
                                        className="hidden"
                                        id="emp-photo-upload-page"
                                    />
                                    <label
                                        htmlFor="emp-photo-upload-page"
